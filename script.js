...
const PLACES = [
...

  {
    ...
    category: 'market',
    teaser: '',
    about: 'เป็นตลาดเก่าแก่ที่มีสภาพค่อนข้างสมบูรณ์และยังคงบรรยากาศวิถีชีวิตริมคลองที่เรียบง่าย เป็นเรือนแถวไม้สองชั้นหลายคูหา หลังคาปั้นหยา พื้นตลาดเป็นพื้นไม้สามารถเดินต่อกันได้ยาวเกือบ 1 กิโลเมตร มีร้านค้าเรียงรายตลอดทางมีสินค้าทั้งเก่าและใหม่ให้เลือกสรรมากมาย เปิดทำการวัน เสาร์-อาทิตย์ เวลา 08.00 - 12.00 น.',
...

  {
    ...
    category: 'temple',
    teaser: '',
     about: 'เป็นชื่อของวัดพระอารามหลวงชั้นตรีที่มีประวัติความเป็นมาอันยาวนานและมีชื่อเสียงแห่งหนึ่งของอำเภอบางพลี จังหวัดสมุทรปราการ เพราะเป็นวัดที่ใช้ประดิษฐานหลวงพ่อโตซึ่งเป็นพระพุทธรูปสมัยสุโขทัยปางมารวิชัย และเป็นหนึ่งในพระสามพี่น้อง เวลาทำการ: ทุกวัน ตั้งแต่เวลา 08.00 น. – 17.00 น.',
...

  {
    ...
    category: 'nature',
    teaser: '',
     about: 'เป็นแหล่งผลิตอากาศบริสุทธิ์ สวนสาธารณะสำหรับพักผ่อนหย่อนใจและออกกำลังกายของประชาชน และเป็นที่ศึกษาระบบนิเวศของพันธุ์พืชและพันธุ์สัตว์ในท้องถิ่นและพื้นที่ใกล้เคียง นอกจากนี้ สวนศรีนครเขื่อนขันธ์ยังมีหอดูนกที่ได้รับความนิยมจากนักดูนกที่ไม่ต้องการออกไปต่างจังหวัดไกลๆ เปิดทำการเวลา 05.00น.-19.00น  ',
  ...
  },
  {
    ...
    category: 'landmark',
    teaser: '',
    about: '“พิพิธภัณฑ์เพื่อการเรียนรู้ และการพักผ่อนหย่อนใจ” ซึ่งนอกจากเนื้อหาด้านปลากัดและความสวยงามของปลากัดสายพันธุ์ต่างๆ ที่ได้จัดแสดงไว้ ยังมีสิ่งที่น่าสนใจอื่นๆ อาทิ เช่น คุณค่าของสถาปัตยกรรมเรือนไทยประยุกต์ การจัดแสดงพันธุ์ปลาที่มีแหล่งกำเนิดจากแม่น้ำเจ้าพระยา สามล้อถีบ สัญลักษณ์ประจำเมืองพระประแดง เปิดให้เข้าชมฟรีทุกวันเสาร์-อาทิตย์ ตั้งแต่เวลา 10.00-17.00 น.',
...

  {
    ...
    category: 'temple',
    teaser: '',
     about: 'ศาลหลักเมืองสถาปัตยกรรมไทยโบราณ ตกแต่งลวดลายไม้แกะสลักงดงาม เป็นที่เคารพสักการะเพื่อความเป็นสิริมงคลแก่ผู้ที่มาเยือน และเป็นศูนย์รวมจิตใจของชาวพระประแดง เวลาทำการเปิด-ปิด 06:00-18:00 น.',
  ...
  },
  {
  ...
  },
   {
    ...
    category: 'landmark',
    teaser: '',
    about: 'บรรยากาศร่มรื่น เต็มไปด้วยต้นไม้สีเขียวรอบตัว เหมือนหลุดมาอยู่บ้านกลางป่า มีกิจกรรม Workshop หลากหลายให้เลือก ไม่ว่าจะเป็น เพ้นต์ภาพ, มัดย้อมผ้า, พายเรือคายัก, ล่องเรือไม้ เวลาทำการ เปิดทุกวัน 8.30-17.30น.',
...

  {
    ...
    category: 'landmark',
    teaser: '',
     about: 'เป็นวัดราษฎร์ที่อยู่ฝั่งตรงข้ามศาลากลางจังหวัดสมุทรปราการ มีผู้คนเดินทางมาเคารพสักการะบูชากันอย่างไม่ขาดสาย และยังเป็นสัญลักษณ์ประจำจังหวัดสมุทรปราการ เวลาทำการ  05:00-20:00น. ',
...

  {
    ...
    category: 'landmark',
    teaser: '',
    about: 'ป้อมปืนประวัติศาสตร์สมัยรัชกาลที่ 5 สร้างขึ้นเพื่อป้องกันการรุกรานจากชาติตะวันตก จัดแสดงพิพิธภัณฑ์เรือหลวง และธรรมชาติป่าชายเลน เวลาทำการ 08:30-21:00น.',
...

  {
  ...
  },
   {
    ...
    category: 'landmark',
    teaser: '',
    about: 'ตลาดน้ำกลางวัดที่อบอวลไปด้วยกลิ่นอายของวิถีชีวิตดั้งเดิม อาหารพื้นบ้านแสนอร่อย หัตถกรรมจากชุมชน และบรรยากาศอันเงียบสงบริมสายน้ำ ที่นี่คือศูนย์รวมของรอยยิ้ม น้ำใจ และความอบอุ่นจากชาวบ้านในพื้นที่ ที่พร้อมต้อนรับทุกคนด้วยความจริงใจ เปิดทุกวัน ศุกร์ - อาทิตย์ วันศุกร์ เปิด 09.00 - 17.00น. เสาร์, อาทิตย์ เปิด 07.00 - 16.00น.',
  ...
  },
   {
    ...
    category: 'cafe',
    teaser: '',
    about: 'NEW Cafe ร้านอาหารริมน้ำที่ให้คุณได้ผ่อนคลายไปกับบรรยากาศสุดชิล และชมพระอาทิตย์ตกดินสุดโรแมนติก  พร้อมอิ่มอร่อยไปกับเมนูอาหารและเครื่องดื่มหลากหลาย  ที่คัดสรรมาเพื่อคุณโดยเฉพาะไม่ว่าจะมากับเพื่อน, คนรัก, หรือครอบครัว NEW Cafe ก็พร้อมมอบช่วงเวลาดี ๆ ที่น่าจดจำให้คุณเสมอ เปิดทุกวัน เวลา 12:00-24:00 น.',
  ...
  },
   {
    ...
    category: 'cafe',
    teaser: '',
    about: 'เหมาะสำหรับนั่งดื่ม ลองค็อกเทล เป็นร้านสไตล์น่ารักแนวแคมปิ้งตกแต่งออกมาได้นั่งชิลล์ชิลล์เหมือน นั่งแคมปิ้งกับเพื่อนๆ มีเมนูอาหารให้เลือกหลากหลายรายการทั้งอาหารไทย อาหารอีสานหรือ จะเป็นอาหารจานเดียว ปลาเผา จิ้มจุ่ม เปิด 17.30-00.00 น.',
...

  {
    ...
    category: 'landmark',
    teaser: '',
     about: 'หาดชูใจ ทะเลน้ำจืดสมุทรปราการ เปิดใหม่ใกล้กรุงเทพฯ พื้นที่กว่า 40 ไร่ มุมถ่ายรูปเพียบ เครื่องเล่นอลังการจัดเต็มรอชาวแก๊งและครอบครัว เปิดทำการเวลา 08:30-20:00น.',
  ...
  },
  {
    ...
    category: 'landmark',
    teaser: '',
    about: 'Let Me Tell You Our Story Cafe เป็นคาเฟ่สไตล์ฝรั่ง บ้านไม้สีน้ำตาล ท่ามกลางต้นไม้เยอะๆ มีละอองน้ำพ่นคลุ้งแบบโคตรสดชื่น บรรยากาศดีจนลืมไปเลยว่าอยู่ใกล้กรุงเทพ มุมถ่ายรูปเพียบ เดินไปทางไหนก็สวย เปิดบ้าน 09.00 น.ปิดรับรายการ 17.30 น. ปิดพักบ้านวันพฤหัสบดี',
    transport: 'รถยนต์ส่วนตัว: ซ.วัดศรีวารีน้อย อ.บางเสาธง',
  ...
  },
  {
    ...
    category: 'cafe',
    teaser: '',
     about: 'ดินแดนสวรรค์กลางทุ่งนา ทุ่งนาสีเขียวขจี ท้องฟ้าสีคราม อากาศบริสุทธิ์ บวกกับการตกแต่งสไตล์ไทยร่วมสมัย ที่ผสมผสานกลิ่นอายธรรมชาติ ไม้ไผ่ หลังคาฟาง และเฟอร์นิเจอร์ไม้ สร้างบรรยากาศอบอุ่น ผ่อนคลาย เหมือนมาพักผ่อนหย่อนใจ  เปิดทุกวัน 11.00 - 21.00 น.',
