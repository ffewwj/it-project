...
const PLACES = [
  {
    ...
    category: 'landmark',
    teaser: '',
    about: 'เมืองโบราณในเนื้อที่ 800 ไร่ ได้กำหนดให้มีความคล้ายคลึงกับลักษณะโดยรวมของแผนที่ประเทศไทย ตลอดจนตำแหน่งที่สร้างโบราณสถานที่ถ่ายแบบมาก่อสร้างและผาติกรรมมาบูรณะปฏิสังขรก็จัดวางตำแหน่งให้ตรงตามภูมิภาคต้นแบบ โดยแบ่งสัดส่วนเป็น 4 ภูมิภาคตามลักษณะทางภูมิวัฒนธรรมของประเทศไทย คือ ภาคเหนือ ภาคอีสาน ภาคกลางและภาคใต้ แล้วสร้างสถาปัตยกรรมในพื้นที่เหล่านั้นให้สอดคล้องคล้ายคลึงกับสถานที่ต้นแบบ',
...

  {
    ...
    category: 'landmark',
    teaser: '',
     about: 'เป็นฟาร์มจระเข้ที่ใหญ่ที่สุดในโลก มีพื้นที่กว่า 400 ไร่ ภายในมีการจัดแสดงจระเข้หลากหลายสายพันธุ์ รวมถึงสัตว์อื่น ๆ เช่น งู, นก, และสัตว์เลี้ยงลูกด้วยนม มีการแสดงโชว์จระเข้และกิจกรรมให้นักท่องเที่ยวได้สัมผัสใกล้ชิดกับจระเข้',
...

  {
    ...
    category: 'landmark',
    teaser: '',
     about: 'สวนสนุกเมืองหิมะในร่มแห่งแรกในสมุทรปราการ สนุกกับลานหิมะจริง สไลเดอร์น้ำแข็ง และโซนถ่ายรูปตลอดทั้งปี',
